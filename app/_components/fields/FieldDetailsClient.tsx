      ...
      <div className="flex flex-col xl:flex-row w-full p-6 md:p-8 gap-8 relative z-10 max-w-[1440px] mx-auto mt-24">
            ...
            <div className="absolute bottom-10 left-10 right-10">
              ...
              >
                <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-none italic uppercase">
                  {FIELD_DATA.name} <br />
                  <span className="text-[#ccff00] not-italic">
                    {FIELD_DATA.subtitle}
                  </span>
                </h1>
        ...
        <div className="w-full xl:w-[400px] flex flex-col gap-6 shrink-0">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h2 className="text-3xl font-black mb-8 italic uppercase tracking-tighter">
                RESERVE THE <span className="text-[#3b82f6]">PITCH</span>
              </h2>
              ...
              <div className="space-y-6 flex-1">
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-[#ccff00] text-xs font-bold underline opacity-60 group-hover:opacity-100 transition-opacity uppercase tracking-tighter">
                      View Slots
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 relative z-10">
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 20px 40px rgba(204,255,0,0.25)",
                  }}
                  whileTap={{ scale: 0.98 }}
          ...
          >
            ...
            <p className="text-black/60 text-[10px] font-black mt-2 uppercase tracking-[0.2em] relative z-10">
              Unlock Member Perks
            </p>
          </motion.div>
