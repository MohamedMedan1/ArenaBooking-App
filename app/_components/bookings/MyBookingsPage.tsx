      ...
      <div className="container max-w-5xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex bg-foreground/5 border border-border-alpha rounded-xl p-1">
              <button className="p-2 text-primary bg-foreground/10 rounded-lg">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          <div className="flex bg-foreground/5 border border-border-alpha rounded-2xl p-1.5 w-full md:w-auto">
            {["all", "confirmed", "canceled", "completed"].map((f) => (
              <button
                key={f}
                onClick={() => setFilter(f)}
        ...
        {!isLoading && filteredBookings.length > 0 && (
          <div className="mt-20 text-center">
            <p className="text-foreground/40 text-[10px] font-black uppercase tracking-[0.3em] italic mb-6">
              End of Bookings History
            </p>
