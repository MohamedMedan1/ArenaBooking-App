...
export default function FieldDetails({
  ...
  if (isLoading || !field) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center text-foreground font-sans text-xl tracking-widest font-black uppercase">
        Loading...
      </div>
    );
  }
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage: `linear-gradient(to bottom, rgba(2,2,2,0.1), rgba(2,2,2,0.9)), url('${FIELD_DATA.image}')`,
              }}
            />
              ...
              >
                ...
                <span className="text-[11px] font-bold text-white">
                  ...
                  <span className="opacity-40 font-normal">
                    ({FIELD_DATA.reviewsCount} Reviews)
                  </span>
                </span>
              </motion.div>
            </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold">
                        {FIELD_DATA.capacity} Players Max
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="text-foreground">
                <h3 className="text-xs uppercase tracking-widest opacity-40 font-bold mb-1">
                  Surface
                </h3>
        ...
        <div className="w-full lg:w-[360px] flex flex-col gap-6">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <p className="text-[10px] uppercase tracking-[0.3em] opacity-40 mb-2 font-bold">
                Session Booking
              </p>
              <h2 className="text-3xl font-black mb-8 italic uppercase tracking-tighter">
                RESERVE THE <span className="text-accent">PITCH</span>
              </h2>
              ...
              <div className="space-y-6 flex-1">
                <div
                  ...
                  onClick={() =>
                    router.push(`/fields/${resolvedParams.fieldId}/slots`)
                  }
                >
                  <p className="text-[10px] uppercase tracking-widest opacity-40 mb-2 font-bold">
                    Selected Date
                  </p>
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-primary text-xs font-bold underline opacity-60 group-hover:opacity-100 transition-opacity uppercase tracking-tighter">
                      Change
                    </span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-foreground/5 border border-border-alpha">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-1 bg-accent/20 text-accent text-[10px] font-black rounded uppercase tracking-widest">
                      Available
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-border-alpha">
                  <div className="flex justify-between items-end mb-8">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-bold opacity-40 line-through tracking-tighter">
                        $110.00
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8 relative z-10">
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 20px 40px rgba(var(--primary),0.25)",
                  }}
                  whileTap={{ scale: 0.98 }}
          ...
          >
            ...
            <p className="text-accent-foreground/70 text-[10px] font-black mt-2 uppercase tracking-[0.2em] relative z-10">
              Unlock Member Perks
            </p>
          </motion.div>
